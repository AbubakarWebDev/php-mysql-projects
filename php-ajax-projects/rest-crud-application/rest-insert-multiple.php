<?php
    ...
    // Multiple Sql Query For Inserting Records On Database
    foreach ($data as $arr) {
        $sql .= "INSERT INTO person (name, phone, address) VALUES ('{$arr['name']}', '{$arr['phone']}', '{$arr['address']}');";
    }
    ...
    {
        echo json_encode(array("message" => "Your Records is Inserted Successfully!", "status" => true), JSON_PRETTY_PRINT);
    }
    else {
        label:
